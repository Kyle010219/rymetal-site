  ...
  return (
    <footer className="bg-brand-dark text-white">
      <div className="container-xl grid gap-10 py-14 md:grid-cols-4">
        <div>
          <div className="text-2xl font-black"><span className="text-brand-orange">RY</span> METAL</div>
      ...
      <div className="border-t border-white/10 py-5 text-center text-xs text-slate-400">© 2026 RYMETAL. All rights reserved.</div>
    </footer>
  );
}
