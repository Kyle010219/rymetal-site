...
export default function Home() {
  return (
    <main className="bg-white">
      ...
      <section className="max-w-7xl mx-auto py-32 relative overflow-hidden bg-white px-8">
        ...
        <div className="grid gap-10 md:grid-cols-3 relative z-10">
          {categories.slice(0, 3).map((c: Category, index) => (
            <Link 
              ...
              className="group relative min-h-[620px] bg-white rounded-[3rem] border border-slate-50 shadow-2xl shadow-slate-200/50 hover:shadow-blue-100/40 transition-all duration-1000 overflow-hidden flex flex-col p-12"
            >
              {/* Background Geometric Number */}
              <div className="absolute top-8 right-8 text-[220px] font-black leading-none italic pointer-events-none select-none text-slate-50 group-hover:text-[#FF9900]/5 transition-colors duration-700">
                0{index + 1}
              </div>
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-[11px] font-bold uppercase tracking-[0.3em] text-blue-600 group-hover:text-[#FF9900]">Series 0{index + 1}</span>
                </div>
                ...
                <p className="text-[11px] font-bold text-slate-400 uppercase tracking-widest leading-loose max-w-[220px] group-hover:text-slate-600 transition-colors duration-500">
                ...
                {c.image ? (
                  <div className="relative z-20 w-full h-full flex items-center justify-center">
                     <img 
                      src={c.image} 
                      alt={c.name} 
                      className="max-h-full max-w-[125%] object-contain drop-shadow-[0_35px_35px_rgba(0,0,0,0.15)] group-hover:drop-shadow-[0_45px_45px_rgba(59,130,246,0.1)] transition-all duration-1000 transform group-hover:scale-110 group-hover:-translate-y-4" 
                    />
                  </div>
                ) : (
              ...
              <div className="relative z-10 mt-auto pt-6 border-t border-slate-50 flex justify-between items-center">
                <span className="text-[11px] font-black uppercase tracking-[0.2em] text-slate-900 group-hover:text-blue-600 transition-colors duration-500">Master Collection</span>
